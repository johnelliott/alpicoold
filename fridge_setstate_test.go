	...
	t.Run("CRC", func(t *testing.T) {
		c := SetStateCommand{
			...
			Settings: Settings{
				...
				TempCompGTE6MinusDegCelsiusMenuE6: 0,
				TempCompGTE12MinusDegCelsiusLT6MinusDegCelsiusMenuE7: 0,
				TempCompLT12MinusDegCelsiusMenuE8:                    -5,
	...
	t.Run("MarshalBinary", func(t *testing.T) {
		c := SetStateCommand{
			...
			Settings: Settings{
				...
				CelsiusFahrenheitModeMenuE5:       true,
				TempCompGTE6MinusDegCelsiusMenuE6: 0x00,
				TempCompGTE12MinusDegCelsiusLT6MinusDegCelsiusMenuE7: 0x00,
				TempCompLT12MinusDegCelsiusMenuE8:                    -5,
