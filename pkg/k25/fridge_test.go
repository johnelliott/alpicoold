	...
	t.Run("CRC", func(t *testing.T) {
		c := SetStateCommand{
			...
			Settings: Settings{
				...
				HLvl:                              1,
				TempSet:                           67,
				LowestTempSettingMenuE1:           68,
				HighestTempSettingMenuE2:          -4,
				HysteresisMenuE3:                  4,
				SoftStartDelayMinMenuE4:           0,
				CelsiusFahrenheitModeMenuE5:       true,
				TempCompGTEMinus6DegCelsiusMenuE6: 0,
				TempCompGTEMinus12DegCelsiusLTMinus6DegCelsiusMenuE7: 0,
				TempCompLTMinus12DegCelsiusMenuE8:                    -5,
				TempCompShutdownMenuE9:                               0,
			},
		}
	...
	t.Run("MarshalBinary", func(t *testing.T) {
		c := SetStateCommand{
			...
			Settings: Settings{
				...
				HLvl:                              1,
				TempSet:                           0x43,
				LowestTempSettingMenuE1:           0x44,
				HighestTempSettingMenuE2:          -4,
				HysteresisMenuE3:                  0x04,
				SoftStartDelayMinMenuE4:           0x00,
				CelsiusFahrenheitModeMenuE5:       true,
				TempCompGTEMinus6DegCelsiusMenuE6: 0x00,
				TempCompGTEMinus12DegCelsiusLTMinus6DegCelsiusMenuE7: 0x00,
				TempCompLTMinus12DegCelsiusMenuE8:                    -5,
				TempCompShutdownMenuE9:                               0x00,
			},
			Checksum: 0x496,
		}
